...
# # --- Senior-style single async function for JSON-based queries ---
# async def main(query: str, detected_lang: str = "en",session_id="default_session"):
#     """
#     Process a user query in a single async function:
#     - Load embedding model and LLM
#     - Retrieve top docs from Milvus
#     - Re-rank, build context, generate response
#     - Translate and clean output
#     """
